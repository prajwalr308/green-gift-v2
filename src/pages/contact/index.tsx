  ...
  return (
    <Layout>
      <section className="max-w-5xl mx-auto mt-16 px-6">
        <h1 className="text-3xl font-semibold mb-8 text-teal-500">Contact GreenGift</h1>
        ...
        <div className="mb-6">
          <h2 className="text-2xl font-semibold mb-4 text-teal-500">Get in Touch</h2>
          <p>Email: <a href="mailto:info@greengift.com" className="underline">info@greengift.com</a></p>
          <p>Phone: +1 (123) 456-7890</p>
        </div>

        <div className="mb-6">
          <h2 className="text-2xl font-semibold mb-4 text-teal-500">Our Address</h2>
          <p>GreenGift HQ</p>
        ...
        <div>
          <h2 className="text-2xl font-semibold mb-4 text-teal-500">Follow Us</h2>
